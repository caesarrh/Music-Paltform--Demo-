  ...
  return (
    <div className="relative h-fit font-neutralFace w-full py-5 px-3">
      ...
      <div className="py-10 flex flex-col">
        <h1 className="text-5xl md:text-7xl font-bold font-[Mafins]">
          Unleash new levels of <br /> CREATIVITY
        </h1>
        <div className="flex my-2 items-end w-full justify-end">
          <h1 className="text-3xl md:text-5xl font-bold mx-4 lg:mx-10 font-[Monument]">
            OFFICE
          </h1>
          <Image src={office} alt="" className="w-[50vw]" />
        </div>
        <h1 className="text-2xl md:text-7xl font-bold flex items-start font-[Monument]">
          FES 
      ...
      <div className="flex flex-col lg:flex-row justify-between py-10 pb-32 ">
        ...
        <div className="text-2xl md:text-3xl lg:text-8xl font-light font-[Monument]">
          HKZPROD.COM
        </div>
      </div>
