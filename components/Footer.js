  ...
  return (
    <div className="relative font-neutralFace px-3">
      <div className="hidden lg:block mb-[10vh]">
        <div className="mx-1 font-monument font-semibold py-10 text-[13.2vmax] my-1 leading-none font-[Monument]">
          HKZ <br /> PROD
        </div>
      </div>
      <div className="flex flex-col lg:flex-row items-start lg:items-center justify-between font-[Mafins]">
        <div>FOLLOW US</div>
      ...
      <div className="flex pt-5 flex-col lg:flex-row items-end lg:items-center justify-between font-[Mafins]">
        <div>TOP</div>
      ...
      <div className="flex flex-col lg:flex-row lg:mt-20 mb-2 items-start lg:items-end justify-between font-[Mafins]">
        ...
        <div>open roles</div>
        <div className="flex space-x-3 mt-5 font-[Mafins]">
          <div>INSTAGRAM</div>
          <div>FACEBOOK</div>
          <div>VIMEO</div>
          <div>SPOTIFY</div>
