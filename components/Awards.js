...
function Awards() {
  return (
    <div className="relative font-neutralFace" id="Awards">
      <div className="bg-[#e7e7e7] text-black h-[80vh]">
        <div className="px-3 py-2">
          <div className="w-full h-[1px] bg-black"></div>
          <div className="flex justify-between w-full text-xs py-2 font-[Mafins]">
            <div>BOLD</div>
            <div>CULTURALLY CONNECTED</div>
            <div>INCLUSIVE</div>
          </div>
          <div className="my-28 font-[Monument]">
      ...
      <div className="h-[50vh] sm:h-[70vh] bg-black text-[#e7e7e7]">
        <div className="flex items-center justify-center w-full h-full text-center text-7xl sm:text-9xl md:text-[10rem] xl:text-[16rem] leading-none">
          <h1 className="-mt-[50vh] mix-blend-difference font-[Monument] text-[14rem]">
            WE PLAY <br /> TO WIN
          </h1>
        </div>
      </div>
